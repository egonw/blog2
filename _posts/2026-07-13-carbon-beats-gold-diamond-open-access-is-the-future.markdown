---
layout: post
title:  "Carbon beats gold: Diamond Open Access is the future #1"
date:   2026-07-13
...
libraries. That was expensive. Therefore, many libraries provided only access to a subset of journals.

Then the internet came. Big publishers started sharing offering digital-only subscriptions. This would lower the cost
and therefor the prize. That was the idea. But the big publishers remained expensive publishers.

Then open access came. The idea is that journal article would have a open license, often CC-BY or similar. This meant
...
remained expensive publishers.

Then came the article-processing charge (APC) model. The authors would contribute for the publishing and distribution
...
confusion, the big publishers remained expensive publishers.

This is where we are now. Because sharing knowledge was a great idea, we want to keep the license, but we need
to drop the financial incentives: we need to drop the APC.

Enter the world of [diamond open access](https://en.wikipedia.org/wiki/Diamond_open_access), where science is
published under an open license, and neither the reviewers, not the readers, nor the authors pay, all key stakeholder
in the exchange of scientific knowledge. And no tax by publishers.
